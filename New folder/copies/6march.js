...
var computerTurn = function(){
           var compCount = 0;
	       var flag = false;
for(var c=0;c<$(".table_card img").length-1;c++)
    {
        console.log($(".table_card > img").attr("value"))
     if($(".computer_card img").attr("value") == $(".table_card img").eq(c).attr("value"))  
          {
           $(".table_card img").eq(c).fadeOut(500);
           $(".computer_card img").fadeOut(500);
            flag = true;
              compCount++;
              $(".computer").html("computerScore = "+ " "+compCount);
          }
     else if($(".computer_card img").attr("value") =="jack"  || $(".computer_card img").attr("src") == "./cards/7_of_diamonds.png")
            {
                $(".table_card img").eq(c).fadeOut(500);
                $("computer_card img").fadeOut(500);
                flag = true;
...
for(var z=0;z<$(".table_card img").length;z++)
       { 
        ...
        if($(this).attr("value") == $(".table_card img").eq(z).attr("value"))
            ...
            {
                $(".table_card img").eq(z).fadeOut(200);
                $(this).fadeOut(200);
                flag = true;
                playerCount +=10
                $(".player").html("playerScore = " + " "+playerCount);
