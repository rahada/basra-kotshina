...
//                console.log(deckCards[player_card].name)
   ...
   /////////////////////////////////////end of COMPUTER function   
        ...
        for(var i=0;i< 4; i++)
          {
            ...
            if(deckCards[jack_card].name == "./cards/jack_of_clubs.png" ||
    ...
    //remove jack and diamond on the ground to make basra 
//    if(var basra == false)
...
//     }
    ...
    var computerTurn = function(x){
             var y = "<img src=" + $(".computer_card img").eq(x).attr("src")+">" ;
                          $(".table_card") .append(y);
                          $(".computer_card img").eq(x).fadeOut(500)
                          };  
