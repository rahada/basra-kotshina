        ...
        for(var i=0; i< 4; i++)
            {
                ...
                $(".computer_card img").eq(i).attr("src","./cards/facedown.png");
                $(".computer_card img").eq(i).attr("value", deckCards[player_card].value);
                $(".computer_card img").eq(i).attr("temp", deckCards[player_card].name);
...
//                playerCount +=2;
           ...
           for(var a=0;a<$(".table_card img").length;a++)
    {
        for(var b=a+1;b<$(".table_card img").length;b++)
        {
          for(var k=b+1;k<$(".table_card img").length;k++)
          {
            var rem = parseInt($(".table_card img").eq(b).attr("value"))
            var rem2 = parseInt($(".table_card img").eq(a).attr("value"))
                        var rem3 = parseInt($(".table_card img").eq(k).attr("value"))

            if(s.attr("value")==(rem + rem2+rem3))
            { 
                $(".table_card img").eq(k).fadeOut(1000);
                $(".table_card img").eq(b).fadeOut(1000);
                                $(".table_card img").eq(a).fadeOut(1000);
...
//    $(".computer_card img").fadeOut(300);
    ...
    { 
        if($(".computer_card img").attr("value") == $(".table_card img").eq(c).attr("value"))
        {
            ...
            isAppend=false;
                ...
                || $(".computer_card img").attr("temp") == "./cards/7_of_diamonds.png")
        {
            console.log("J or 7+")
    ...
    var sum2 = sumOfCards($(".computer_card img").eq(0))
    if(sum2 == true)
        {
            isAppend=false;
            $(".computer_card img").eq(0).fadeOut(1000)
        }
    
    if(isAppend)
    {
        console.log("yes false")
        var r = $(".computer_card img").eq(0).attr("temp")
      ...
      for(var a=0;a<$(".table_card img").length;a++)
    {
        for(var b=a+1;b<$(".table_card img").length;b++)
        {
          for(var k=b+1;k<$(".table_card img").length;k++)
          {
            ...
            if(kmna.attr("value")==(rem + rem2+rem3))
            { 
                $(".table_card img").eq(k).fadeOut(1000);
                $(".table_card img").eq(b).fadeOut(1000);
                                $(".table_card img").eq(a).fadeOut(1000);
